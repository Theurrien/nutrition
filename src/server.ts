    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      try {
        switch (request.params.name) {
          case 'search_foods': {
            const result = await searchFoods(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'get_food_details': {
            const result = await getFoodDetails(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'get_nutritional_values': {
            const result = await getNutritionalValues(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'compare_nutritional_values': {
            const result = await compareNutritionalValues(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'get_ingredients': {
            const result = await getIngredients(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'calculate_recipe_nutrition': {
            const result = await calculateRecipeNutrition(request.params.arguments as any);
            return {
              content: [
                {
                  type: 'text',
          ...
          case 'set_language_preference': {
            const { userId, language } = request.params.arguments as any;
            if (!userId || !language) {
              throw new McpError(
            ...
            setUserLanguagePreference(userId, language as Language);
