 ...
 */
export function translate(key: keyof typeof translations, language: Language = DEFAULT_LANGUAGE): string {
...
export function formatValueWithUnit(
  ...
  const unitKey = `unit.${unit.toLowerCase()}` as keyof typeof translations;
